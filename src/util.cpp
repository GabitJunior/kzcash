...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\KZCashCore
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\KZCashCore
    // Mac: ~/Library/Application Support/KZCashCore
    // Unix: ~/.kzcashcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "KZCashCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/KZCashCore";
#else
    // Unix
    return pathRet / ".kzcashcore";
#endif
#endif
}
