...
{
    if(fLiteMode) return; // ignore all KZCash related functionality
...
/*
    ...
    allow endless transaction that would bloat KZCash and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("kzcash-privatesend");
