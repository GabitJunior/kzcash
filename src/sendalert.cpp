...
2. run ucomd with -printalert or -sendalert like this:
   /path/to/ucomd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.unitedcryptocommunity.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/UCOM Core:0.12.0.58/"));
