...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "KZCASHNetwork") type = KZCASHNetwork;
    if(strType == "KZCASHNetworkVariable") type = KZCASHNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == KZCASHNetwork) s = "KZCASHNetwork";
    if(type == KZCASHNetworkVariable) s = "KZCASHNetworkVariable";
