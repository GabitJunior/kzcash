...
Only requiring some minor changes is kzcash.cpp.
...
Changes to kzcash.cpp
----------------------
kzcash.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
