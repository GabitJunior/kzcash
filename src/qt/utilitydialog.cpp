    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("UCOM Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About UCOM Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ucom-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the UCOM in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 UCOM, 0.1 UCOM, 1 UCOM and 10 UCOM -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("UCOM Core is shutting down...") + "<br /><br />" +
