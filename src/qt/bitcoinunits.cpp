...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case KZC: return QString("KZCash");
    ...
    else
    {
        switch(unit)
        {
            case KZC: return QString("TestKZCashs");
            case mKZC: return QString("Milli-TestKZCash (1 / 1" THIN_SP_UTF8 "000)");
            case uKZC: return QString("Micro-TestKZCash (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-TestKZCash (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
