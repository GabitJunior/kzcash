...
Only requiring some minor changes is ucom.cpp.
...
Changes to ucom.cpp
----------------------
ucom.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
