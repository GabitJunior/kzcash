    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("KZCash Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About KZCash Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  kzcash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the KZCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KZC, 0.1 KZC, 1 KZC and 10 KZC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("KZCash Core is shutting down...") + "<br /><br />" +
