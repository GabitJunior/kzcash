#!/usr/bin/env python
#
# Use the raw transactions API to spend kzcashs received on particular addresses,
...
#
# Assumes it will talk to a kzcashd or KZCash-Qt running
# on localhost.
#
# Depends on jsonrpc
#
...
def determine_db_dir():
    ...
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/KZCashCore/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "KZCashCore")
    return os.path.expanduser("~/.kzcashcore")
