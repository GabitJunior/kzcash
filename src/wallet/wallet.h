...
enum WalletFeature
{
    FEATURE_BASE = 10100, // the earliest version new wallets supports (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 10100, // wallet encryption
    FEATURE_COMPRPUBKEY = 10100, // compressed public keys
...
public:
    ...
    /// Get 1000UCOM output and keys which can be used for the Masternode
