...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("KZCash Core kzcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kzcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kzcash transaction") + "\n" +
              "  kzcash-tx [options] -create [commands]   " + _("Create hex-encoded kzcash transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kzcash transaction
