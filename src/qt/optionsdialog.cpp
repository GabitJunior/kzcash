    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KZCash-light"), QVariant("light"));
    ui->theme->addItem(QString("KZCash-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KZCash-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KZCash-traditional"), QVariant("trad"));
